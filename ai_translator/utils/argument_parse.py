...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--config',type=str,default='config.yaml',help='Configuration file with mode and API settings.')
    ...
    def parse_arguments(self):
        ...
        if args.model_type=='OpenAIModel' and not args.openai_model and not args.openai_api_key:
            self.parser.error('--openai_model and --opanai_api_key is required when using OpenAIModel')
        return args    