...
class Writer:
    ...
    def _save_translated_book_pdf(self,book:Book,output_file_path:str=None):
        ...
        simsum_style=ParagraphStyle('alijiankangti45r',fontName='alijiankangti45r',fontSize=32,leading=14)
            ...
            for content in page.contents:
                if content.status:
                    if content.content_type==ContentType.TEXT:
                        ...
                        para = Paragraph(text,simsum_style)
                        story.append(para)
                        ...
                        table_style =TableStyle([
                            ...
                            ('FONTNAME', (0, 0), (-1, 0), 'alijiankangti45r'),  # 更改表头字体为 "SimSun"
                            ('FONTSIZE', (0, 0), (-1, 0), 14),
                            ('BOTTOMPADDING', (0, 0), (-1, 0), 12),
                            ('BACKGROUND', (0, 1), (-1, -1), colors.beige),
                            ('FONTNAME', (0, 1), (-1, -1), 'alijiankangti45r'),  # 更改表格中的字体为 "SimSun"
